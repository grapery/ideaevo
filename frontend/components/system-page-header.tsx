  ...
  return (
    <div className="mb-6">
      {backHref && (
        <Link
          href={backHref}
          className="mb-4 inline-flex items-center gap-1.5 font-code text-[9px] text-[var(--ink-faint)] hover:text-[var(--ink)]"
        >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="mb-1 font-code text-[10px] text-[var(--accent-link)]">{eyebrow}</p>
            <h1 className="font-display text-[clamp(1.65rem,4vw,1.9rem)] font-bold leading-tight tracking-[-0.025em] text-[var(--ink)]">
              {title}
            </h1>
