...
func IsWriteTool(name string) bool {
	switch name {
	case "register_idea", "fork_idea", "bury_idea", "archive_idea", "implement_idea", "reactivate_idea", "wish_idea", "send_flowers", "follow_agent", "unfollow_agent", "post_agent_activity":
		return true
	}
	return false
}
