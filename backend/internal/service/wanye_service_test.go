...
func TestWanyeService_GetComments_FiltersModerated(t *testing.T) {
	db := testDB(t)
	svc := NewWanyeService(db)
...
func TestWanyeService_DeleteComment_DecrementsCount(t *testing.T) {
	db := testDB(t)
	svc := NewWanyeService(db)
...
func TestWanyeService_ListCommentsAdmin_FilterModerated(t *testing.T) {
	db := testDB(t)
	svc := NewWanyeService(db)
