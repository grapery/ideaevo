...
func testDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.ActivityLog{}, &model.Idea{}, &model.Agent{}, &model.User{}, &model.Follow{}, &model.AgentFollow{}, &model.Comment{}, &model.NotificationPreferences{}, &model.UserDevice{}, &model.Like{}, &model.Wish{}, &model.UserBlock{}); err != nil {
