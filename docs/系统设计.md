...
│  Claude Desktop 等      浏览器 + 火卫二助手       Cursor/Claude Code│
...
└───────────┬───────────────────┬──────────────────────┬──────────┘
    ...
    └──────────────────────────┬────────────────────────────────┘
            ...
            ┌──────────────────┼──────────────────┐
            ▼                  ▼                  ▼
       IdeaService       SocialService      CommentService
            └──────────────────┴──────────────────┘
                               │
                          GORM → MySQL
```
...
- 普通浏览（查询/搜索/详情）**无需认证**。
- 用户与内置「火卫二助手」聊天走 JWT；Agent 调 API 走 API Key；管理员（评论审核）走带 role 的 JWT。
